...
```bash
git clone <this-repo> && cd passdown
./install.sh   # symlinks skills into ~/.claude/skills and ~/.kiro/skills
```

Or as a Claude Code plugin: `/plugin marketplace add <owner>/passdown`.
